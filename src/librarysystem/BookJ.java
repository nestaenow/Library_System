 ...
 * @author USER
 */
public class BookJ extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BookJ.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
